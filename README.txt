...
* Publish, un-publish and manage Instant Articles from the WP article page.
* Override global settings on a per article basis.
* Facebook Articles synced instantly with WP ones.
* Errors & import status live in every article.
* Full instant article analytics, individual and aggregated site overview.
* Branded articles.
* Premium support.

**Future**
A few of the features planned for the near future.
